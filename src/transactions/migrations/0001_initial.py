    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('BP', 'Bid Placed'), ('CS', 'Cost Per Sale'), ('BC', 'Bid Revoked'), ('BA', 'Bid Accepted'), ('AR', 'Account Recharge'), ('AW', 'Account Withdrawal'), ('AA', 'Admin Adjustment'), ('OT', 'Other')], db_column='tranType', max_length=2)),
