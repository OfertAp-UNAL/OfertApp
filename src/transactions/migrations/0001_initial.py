# Generated by Django 3.2.16 on 2023-04-13 21:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Account',
            fields=[
                ('id', models.OneToOneField(db_column='usrId', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='account', serialize=False, to='users_auth.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(db_column='admId', null=True, on_delete=django.db.models.deletion.CASCADE, to='users_auth.admin')),
                ('offer', models.ForeignKey(db_column='offId', null=True, on_delete=django.db.models.deletion.CASCADE, to='publications.offer')),
                ('payment', models.ForeignKey(db_column='payId', null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.payment')),
            ],
        ),
    ]
